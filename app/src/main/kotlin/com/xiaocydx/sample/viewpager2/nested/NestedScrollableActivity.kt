...
import com.xiaocydx.cxrv.viewpager2.nested.Vp2NestedScrollableHost
 ...
 * 1. [NestedPageHeader]，水平方向ViewPager2（Parent）和水平方向ViewPager2（Child）。
 * 2. [NestedPageOuterListAdapter]，水平方向ViewPager2（Parent）和水平方向RecyclerView（Child）。
 ...
 *
 * [Vp2NestedScrollableHost]是使用[Vp2NestedScrollableHandler]的容器方案。
 *
 * @author xcc
 * @date 2022/4/6
 */
