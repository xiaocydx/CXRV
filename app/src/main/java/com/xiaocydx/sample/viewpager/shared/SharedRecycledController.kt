 ...
 * @date 2022/4/13
 */
class SharedRecycledController(
    fm: FragmentManager,
    private val sharedPool: RecycledViewPool
) : FragmentManager.FragmentLifecycleCallbacks(), ViewPager.OnPageChangeListener {
    ...
    private class AttachAction private constructor(
        ...
        ) : this(isCurrent, isPreset, isLoaded, WeakReference(fragment))
