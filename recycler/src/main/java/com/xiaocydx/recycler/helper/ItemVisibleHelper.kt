...
import com.xiaocydx.recycler.extension.findFirstCompletelyVisibleItemPosition
import com.xiaocydx.recycler.extension.findFirstVisibleItemPosition
 ...
 * item可视帮助类
 *
 * 适用于监听RecyclerView滚动，频繁判断item是否可视、获取可视item位置的场景，
